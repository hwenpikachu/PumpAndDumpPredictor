...
# --- Load & prep ---
df = pd.read_csv('Coinbase_BONKUSD_5min.csv')
...
def generate_event_reports(
    ...
    # Write files
    pumps_path = 'bonk_pumps_by_candle.csv'
    dumps_path = 'bonk_dumps_by_candle.csv'
    pumps_day_path = 'bonk_pumps_by_day.csv'
    dumps_day_path = 'bonk_dumps_by_day.csv'
    seq_path = 'bonk_pump_then_dump_sequences.csv'
...
# Save to file
out_path = 'BONK_5min_pump_predictions.csv'
