...
def fetch_candles_with_timeout(product_id="PEPE-USD", granularity=300, max_minutes=5):
    """
...
if __name__ == "__main__":
    print("Fetching 5-minute PEPE-USD candles (up to 5 minutes runtime)...\n")
    ...
    df.to_csv("Coinbase_PEPEUSD_5min.csv", index=False)
    print("\n Saved as Coinbase_PEPEUSD_5min.csv")
