...
def fetch_candles_with_timeout(product_id="FLOKI-USD", granularity=300, max_minutes=5):
    """
...
if __name__ == "__main__":
    print("Fetching 5-minute FLOKI-USD candles...\n")
    ...
    df.to_csv("Coinbase_FLOKIUSD_5min.csv", index=False)
