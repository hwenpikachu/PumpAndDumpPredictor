...
# --- Load & prep ---
df = pd.read_csv('Coinbase_FARTUSD_5min.csv')
...
def generate_event_reports(
    ...
    # Write files
    pumps_path = 'fart_pumps_by_candle.csv'
    dumps_path = 'fart_dumps_by_candle.csv'
    pumps_day_path = 'fart_pumps_by_day.csv'
    dumps_day_path = 'fart_dumps_by_day.csv'
    seq_path = 'fart_pump_then_dump_sequences.csv'
...
# Save to file
out_path = 'FART_5min_pump_predictions.csv'
